...
<div class="row">
  ...
  <img class="wizardScreenShot bigScreen" src="images/wizard4.png">
  </div>
  ...
  <br>
  <br>
  Change the name of this calendar to "Public".  
  <br>
  <br>
...
function validateEntry(){
        window.location.href = "wizard5.php";
}
