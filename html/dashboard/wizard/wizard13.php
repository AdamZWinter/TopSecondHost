...
<div class="row">
  ...
  <img class="wizardScreenShot bigScreen" src="images/wizard13.png">
  </div>
  ...
  <br>
  <br>
  Name this calendar "Availability" and Create calendar.
...
function validateEntry(){
        window.location.href = "wizard14.php";
}
