...
<div class="row">
  ...
  <img class="wizardScreenShot bigScreen" src="images/wizard9.png">
  </div>
  ...
  <br>
  <br>
  Paste the code into the website page where you want your customers to find it, and save the change.
  <br>
  <br>
  If you're using Wordpress, make sure that you're using the code editor. (Text, not Visual)
  </p>
  <br>
  <br>
  </div>
...
function validateEntry(){
        window.location.href = "wizard10.php";
}
