...
<div class="row">
  ...
  <img class="wizardScreenShot bigScreen" src="images/wizard5.png">
  </div>
  ...
  <br>
  <br>
  Check the box to "Make available to public" and "OK" the warning. 
  </p>
  <br>
  <br>
  </div>
...
function validateEntry(){
        window.location.href = "wizard6.php";
}
