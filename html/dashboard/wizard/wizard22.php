...
<div class="row">
  ...
  <img class="wizardScreenShot bigScreen" src="images/wizard22.png">
  </div>
  ...
  <br>
  <br>
  To add additional entries, click on an entry, then Options, and choose "Duplicate".
  <br>
  <br>
  </p>
  </div>
...
function validateEntry(){
        window.location.href = "wizard23.php";
}
