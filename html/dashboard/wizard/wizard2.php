...
<div class="row">
  ...
  <img class="wizardScreenShot bigScreen" src="images/wizard2.png">
  </div>
  ...
  <br>
  <br>
  With your calendar open in Google, click the gear icon and choose "settings" to access your calendar settings.
  </p>
  <br>
  <br>
  </div>
...
function validateEntry(){
        window.location.href = "wizard3.php";
}
