...
<div class="row">
  ...
  <img class="wizardScreenShot bigScreen" src="images/wizard21.png">
  </div>
  ...
  <br>
  <br>
  You can now edit the Available calendar entry to have it repeat on other days or change the location, title, Resource, Price, Tax, and Description.
  <br>
  <br>
  </p>
  </div>
...
function validateEntry(){
        window.location.href = "wizard22.php";
}
