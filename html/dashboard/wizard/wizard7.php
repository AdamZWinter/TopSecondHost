...
<div class="row">
  ...
  <img class="wizardScreenShot bigScreen" src="images/wizard7.png">
  </div>
  ...
  <br>
  <br>
  Under "Integrate Calendar" choose "Customize".
  </p>
  <br>
  <br>
  </div>
...
function validateEntry(){
        window.location.href = "wizard8.php";
}
