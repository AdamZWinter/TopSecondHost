...
require('/var/www/html/users/loggedinUser.php');  //includes conf
...
$oldVersion='/var/www/revision/'.$obj->dateread.basename($filename);
...
try
    ...
    if(fwrite($theFile, $contents)){echo 'Saved. Revision history is saved in /var/www/revision';}else{echo 'Failed to write.  ';}
