...
class databaseConfig {
    ...
    private String $database='orangegr_walnut';
    private String $dbuser='orangegr_orangegr'; 
    private String $userpw='GhjxvYFGKh2NXJGlHKgkZFp';

    public function getServer(){return $dbserver;}
    public function getDatabase(){return $database;}
    public function getUser(){return $dbuser;}
    public function getPW(){return $userpw;}
}
